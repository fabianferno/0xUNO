...
const Game = (props) => {
    ...
    (async () => {
      if (winner == "Player 1") {
        ...
        await OxReceiverUNO.endGame(
          ethers.utils.hexlify(ethers.utils.toUtf8Bytes(room)),
          users.find((user) => user.name === "Player 1").address
        );
        console.log("Game successfully Ended");
        console.log("Winner: Player 1, address:" + address);
        ...
        console.log("Game successfully Ended");
        console.log("Winner: Player 2, address:" + address);
      }
    })();
  }, [winner]);
  ...
  const sendMessage = (event) => {
    ...
    if (message) {
      socket.emit("sendMessage", { message: message, address: address }, () => {
        setMessage("");
      });
    }
  };
